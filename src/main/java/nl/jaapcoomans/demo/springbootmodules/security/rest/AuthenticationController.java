package nl.jaapcoomans.demo.springbootmodules.security.rest;

import static org.springframework.http.ResponseEntity.ok;

import java.util.Collections;

import nl.jaapcoomans.demo.springbootmodules.security.JwtTokenProvider;
...
public class AuthenticationController {
	...
	public ResponseEntity<UserInfo> login(@RequestBody LoginCommand loginCommand) {
		try {
			...
			return ok(new UserInfo(username, token));
